...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    /**
     * color vert clair pour jardin PlantVsZombie
     */
    public static final Color LIGHT_GREEN = new Color(120, 220, 30);
    
    /**
     * color pour vert sombre jardin PlantVsZombie
     */
    public static final Color DARK_GREEN = new Color(55, 65, 20);
    
    /**
     * color pour vert jaune jardin PlantVsZombie
     */
    public static final Color YELLOW_GREEN = new Color(95, 100, 10);
 ...
 //       if (frame != null) frame.setVisible(false); // Pb double fenetre sous Linux?
